...
const LiveDetail: NextPage = () => {
  return (
    <div className="py-10 px-4 space-y-4">
      ...
      <div className="pt-10 pb-16 h-[50vh] px-4 overflow-y-scroll space-y-4 scrollbar-hide">
        <div className="flex items-start space-x-2 ">
          <div className="w-8 h-8 rounded-full bg-slate-300" />
          <div className="w-1/2 text-sm texy-gray-700 p-2 border border-gray-300 rounded-md">
      ...
      <div className="fixed w-full mx-auto max-w-md bottom-2 left-0 inset-x-0">
        <div className="flex items-center relative">
          ...
          />
          <div className="absolute inset-y-0 flex py-1.4 pr-1.5 right-0">
            <button className="flex items-center bg-orange-500 rounded-full px-3 hover:bg-orange-600 focus:ring-2 text-sm text-white focus:ring-offset-2 focus:ring-orange-500">
              &rarr;
            </button>
          </div>
        </div>
