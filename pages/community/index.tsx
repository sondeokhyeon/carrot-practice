  ...
  return (
    <Layout hasTabBar title="동네생활">
      <div className="py-16 px-4 space-y-8 ">
        {new Array(5).fill(1).map((el, i) => (
          <Link href={`/community/${el}`} key={i}>
            <div className="flex flex-col cursor-pointer items-start">
              ...
              <div className="mt-5 flex items-center justify-between w-full text-gray-500 font-medium font-sm">
                <span>니꼬</span>
                <span>18시간 전</span>
              </div>
        ...
        {/* map end */}
        <button className="fixed bottom-24 right-5 bg-orange-400 rounded-full p-3 text-white shadow-xl hover:bg-orange-500  cursor-pointer transition-colors">
